...
# filter 2: exclude bubble diagram (tH bubble, tt bubble, and HH bubble)
            if len(diag.get_pdgs_attached_to_loop(structs))<=2:
                valid_diag=False
# Higgs boson must in the line connected to the loop
# filter 3: require Higgs boson connected to the loop
            if diag.get_loop_lines_pdgs().count(25) != 2:
                valid_diag=False
